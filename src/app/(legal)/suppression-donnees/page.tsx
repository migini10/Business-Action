...
export default function SuppressionDonneesPage() {
  const { company, deletion } = siteContent;
  ...
  return (
    <main style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', lineHeight: '1.6' }}>
      ...
      <p style={{ marginBottom: '20px' }}>
        {company.commercialName} vous permet de demander la suppression de vos données personnelles. Cette procédure s&apos;effectue manuellement pour des raisons de sécurité et de conformité légale. {deletion.noInstantButton}.
      </p>
      ...
      <ol style={{ marginLeft: '20px', marginBottom: '30px' }}>
        <li style={{ marginBottom: '10px' }}>
          <strong>Faire la demande :</strong> Envoyez un email depuis votre adresse de contact à <a href={`mailto:${company.privacyEmail}`} style={{ color: '#0070f3' }}>{company.privacyEmail}</a> en précisant le numéro de téléphone associé à votre compte.
        </li>
        <li style={{ marginBottom: '10px' }}>
